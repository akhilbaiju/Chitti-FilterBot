...
from pyrogram import Client as akhilz
...
@akhilz.on_message(filters.command('id') & (filters.private | filters.group))
...
@akhilz.on_message(filters.command('info') & (filters.private | filters.group))
...
@akhilz.on_message((filters.private | filters.group) & filters.command('status'))
...
@akhilz.on_message(filters.command('start') & filters.private)
async def start(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Need Any help from Chitti", callback_data="help_data")
                ]
            ]
        ),
...
@akhilz.on_message(filters.command('help') & filters.private)
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Join Channel", url="https://t.me/honebeemovies"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Youtube", url="https://www.youtube.com/channel/UCe5RaLkqRimYwdWss4FpH2w"),
                    InlineKeyboardButton("Support Group", url="https://t.me/honeybeemoviesgroup")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
...
@akhilz.on_message(filters.command('about') & filters.private)
            ...
            [
                [
                    InlineKeyboardButton(
                        "My GOD", url="https://t.me/akhilbaiju")
                ],
                [
